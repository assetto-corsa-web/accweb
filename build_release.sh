...
cp start.sh "$DIR/start.cmd"
cp -r public "$DIR/public"
rm -rf "$DIR/public/node_modules"
rm -r "$DIR/public/src"
rm -r "$DIR/public/.gitignore"
rm -r "$DIR/public/package.json"
rm -r "$DIR/public/package-lock.json"
rm -r "$DIR/public/webpack.config.js"
